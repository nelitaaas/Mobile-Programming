    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btTwitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent iTwitter = new Intent(MainActivity.this, TwitterLogin.class);
        ...
        btGplus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iGPlus = new Intent(MainActivity.this, GPlusLogin.class);
